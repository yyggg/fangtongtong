...
<div class="user-index layui-form news_list">
	<div class="layui-btn-group demoTable">
        <?php if(Helper::checkRoute('view')): ?>
		    <a href="<?= Url::to(['create']);?>" class="layui-btn" data-type="getCheckData"><i class="layui-icon">&#xe654;</i>新增商品</a>
        <?php endif;?>
	</div>
				...
				'buttons' => [
                    'view' => function ($url, $model, $key){
                        if(Helper::checkRoute('view')){
                            return Html::a('查看', Url::to(['view','id'=>$model['goods_id']]), ['class' => "layui-btn layui-btn-xs layui-btn-normal layui-default-view"]);
                        }
                    },
                    'update' => function ($url, $model, $key) {
                        if(Helper::checkRoute('update')){
                            return Html::a('修改', Url::to(['update','id'=>$model['goods_id']]), ['class' => "layui-btn layui-btn-warm layui-btn-xs layui-default-update"]);
                        }
                    },
                    'delete' => function ($url, $model, $key) {
                        if(Helper::checkRoute('delete')){
                            return Html::a('删除', Url::to(['delete','id'=>$model['goods_id']]), ['class' => "layui-btn layui-btn-xs layui-btn-danger layui-default-delete"]);
                        }
                    },
				]
			],
