						...
						<!--<div id="echarts_box1"  style="width: 50%;height:50%;float: left">
                            <div class="layui-card">
                                ...
                                <div class="layui-card-body">
                                    用户总数：<font color="red"><?/*= $data['userStat']['total']; */?></font> &nbsp;
                                    今日注册总数：<font color="red"><?/*= $data['userStat']['today_reg_total']; */?></font>
                                </div>
                            </div>
						</div>
						<div id="echarts_box2"  style="width: 50%;height:50%;float: left">
                            <div class="layui-card">
                                <div class="layui-card-header">本金动态</div>
                                <div class="layui-card-body">
                                    今日转入：<font color="red"><?/*= number_format($data['amount']['roll_in'] / 100); */?></font> &nbsp;
                                    今日转出：<font color="red"><?/*= number_format($data['amount']['roll_out'] / 100); */?></font>
                                </div>
                            </div>
						</div>
						<div id="echarts_box3"  style="width: 50%;height:50%;float: left">

						</div>
						<div id="echarts_box4"  style="width: 50%;height:50%;float: left">
...
var myChart3 = echarts.init(document.getElementById('echarts_box3'));
var myChart4 = echarts.init(document.getElementById('echarts_box4'));
