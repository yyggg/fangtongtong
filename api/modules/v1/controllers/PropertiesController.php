    ...
    public function actionInfo()
    {
        ...
        $model = Properties::find()
            ...
            ->select([
                ...
                'a.open_time','a.address','a.price_avg','a.price_total_min','a.price_total_max','a.property_type_id','a.content',
        ...
        // 是否关注
        $subscribe = SubscribeProperties::findOne(['properties_id' => $propertiesId, 'user_id' => $this->_userId]);
        $data['info']['collect'] = 0;
        if ($subscribe) {
            $data['info']['collect'] = $subscribe->status;
        }
        ...
        if ($ask)
        {
            $ask[$k]['create_time'] = date('n-d H:i:s', $v['create_time']);
        }
        $data['ask'] = $ask;
